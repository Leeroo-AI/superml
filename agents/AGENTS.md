...
These skills are:
 - ml-debug -> "skills/ml-debug/SKILL.md"
 - ml-experiment -> "skills/ml-experiment/SKILL.md"
 - ml-iterate -> "skills/ml-iterate/SKILL.md"
...
ml-debug: `Use when something is failing in ML/AI work — OOM, NaN, divergence, crashes, bad throughput, wrong outputs, dependency conflicts`
ml-experiment: `Use when starting, logging, or reviewing ML experiments — maintains a persistent experiment journal with hypotheses, results, and learnings across sessions`
ml-iterate: `Use when the user is stuck, needs ranked next steps, or wants alternatives after initial experiments — "I tried X and got Y, what next?"`
